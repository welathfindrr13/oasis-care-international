...
export class CarePlanningResolver {
  ...
  async completeAssessment(
    @Args('input') input: CompleteAssessmentInput,
    @Context() ctx: any,
  ): Promise<AssessmentDTO> {
  ...
  async createCarePlan(
    @Args('input') input: CreateCarePlanInput,
    @Context() ctx: any,
  ): Promise<CarePlanDTO> {
  ...
  async approveCarePlan(
    @Args('input') input: ApproveCarePlanInput,
    @Context() ctx: any,
  ): Promise<CarePlanDTO> {
  ...
  async archiveCarePlan(
    @Args('input') input: ArchiveCarePlanInput,
    @Context() ctx: any,
  ): Promise<CarePlanDTO> {
  ...
  private viewerFromContext(ctx: any): { role: string; organizationId?: string | null; userId?: string | null } {
